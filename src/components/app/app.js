...
const insertionSort_1 = __importDefault(require("../insertionSort/insertionSort"));
    ...
    sort() {
        this.sortBtn.addEventListener('click', () => __awaiter(this, void 0, void 0, function* () {
            switch (this.sortType.value) {
                ...
                case 'insertion-sort':
                    this.disactivateHud();
                    yield insertionSort.func(this.array, this.colors, this.draw, this.render);
                    this.activateHud();
                    return;
                default:
                    return;
...
const insertionSort = new insertionSort_1.default();
new Visualizer();
